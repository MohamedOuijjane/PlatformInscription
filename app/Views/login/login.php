...
<form class="form_container">
  ...
  <div class="input_container">
    ...
    <input placeholder="example@gmail.com" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
  ...
  <button title="Sign Up" type="submit" class="btn btn-danger sign-up_btn">
    <span>Register</span>
  </button>
