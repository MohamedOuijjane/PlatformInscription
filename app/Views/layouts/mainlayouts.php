...
<head>
    ...
    * {
        ...
        /* Espacement personnalisé pour le logo de la navbar */
        .navbar-brand {
            margin-right: 800px; 
            margin-left: 50px;
        }
        ...
        /* Liens et informations de contact dans la barre supérieure */
        ...
        /* Disposition du contenu du pied de page */
        .footer .container {
            display: flex;
        ...
        /* Liens et texte dans le pied de page */
        .footer-section p,
        .footer-section a {
            color: #ddd;
            text-decoration: none;
        ...
        /* Effet hover pour les liens du pied de page */
        ...
        /* Classes pour gérer l'affichage de la navbar lors du défilement */
        .navbar-hidden {
        ...
        .navbar .navbar-nav {
            margin: 0 auto; /* Centrer les liens de navigation */
        }
        ...
        /* Effet hover pour les liens de la navbar */
        .navbar .navbar-nav .nav-link:hover {
            color: #2596be;
        }

        /* Animation de soulignement pour les liens de la navbar */
        ...
        /* Navbar fixée en haut lors du défilement */
        .navbar-fixed-top {
            position: fixed;
            top: 0;
            width: 100%;
            z-index: 1030; /* Priorité d'affichage au-dessus des autres éléments */
            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); /* Ombre subtile */
            background-color: white; /* Couleur de fond */
            transition: top 0.3s ease-in-out; /* Animation d'apparition/disparition */
        }
...
<body>
    ...
    <!-- Deuxième barre de navigation avec menu principal -->
    ...
    <script>
    // Script pour fixer la navbar en haut de la page lors du défilement
