            ...
            <form method="post" action="<?= base_url('ExamsController/addExam') ?>">
                <div class="row g-3">
                    ...
                    <div class="col-md-6 form-group-icon">
                        ...
                        <input type="text" class="form-control ps-4" id="nomExam" name="nomExam" placeholder="Entrer le nom de l'examen" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group-icon">
                        ...
                        <input type="date" class="form-control ps-4" id="dateDebut" name="dateDebut" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group-icon">
                        ...
                        <input type="date" class="form-control ps-4" id="dateLimite" name="dateLimite" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group-icon">
                        ...
                        <input type="date" class="form-control ps-4" id="dateExam" name="dateExam" required>
                    </div>
                    ...
                    <div class="col-md-12 form-group-icon">
                        ...
                        <input type="text" class="form-control ps-4" id="lieuExam" name="lieuExam" placeholder="Entrer le lieu de l'examen" required>
                    </div>
                </div>
