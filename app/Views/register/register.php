...
<form class="form_container" action="<?= base_url('register/store') ?>" method="POST">
  <div class="logo_container">
    ...
    <div class="input_container">
        ...
        <input placeholder="CIN" title="CIN" name="cin" type="text" class="input_field" id="cin_field" value="<?= esc($cin)  ?>" readonly>
    </div>
  <div class="input_container">
    ...
    <input placeholder="Veuillez entrer un nom d'utilisateur" title="Username" name="username" type="text" class="input_field" id="username_field" value="<?= old('username') ?>" required>
  </div>
  <div class="input_container">
  ...
  <div class="input_container">
    ...
    <input placeholder="Veuillez entrer un mot de passe" title="password" name="password" type="password" class="input_field" id="password_field" required>
  </div>
